...
@HaraNativeBinding(namespace = "std.native", name = "Base", methods = {"list", "vector", "vec", "set", "tuple", "hash-map", "hash-set", "atom", "pointer", "symbol", "keyword", "uuid", "reduced", "unreduced", "hash", "apply", "resolve", "number?", "long?", "satisfies?", "special-symbol?", "type", "instance?"})
