...
export async function loadHtaExtension({worker,workerFactory,workerUrl,descriptor,descriptorUrl,packageUrl,moduleBytes,providerUrl,hostCalls={},capabilities=[],instrumentation=false,onProviderEvent}) {
